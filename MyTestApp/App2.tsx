...
import LandingPage from './src/src/View/LandingPage';
import Register from './src/src/View/Register';
import Login from './src/View/Login';
import HomePage from "./src/src/View/Home";
import ProfilePage from './src/src/View/ProfileScreen';
